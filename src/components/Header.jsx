...
const Header = memo(function Header() {
  return (
    <header className="w-full max-w-2xl bg-gradient-to-r from-gray-800 to-gray-900 backdrop-blur-sm text-gray-100 p-6 rounded-b-lg shadow-lg mb-4 cursor-default">
